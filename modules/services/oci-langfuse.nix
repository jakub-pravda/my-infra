  ...
  options.services.oci-langfuse = {
    ...
    langfuse = {
      ...
      encryptionKey = mkOption {
        type = types.str;
        description = "Langfuse encryption key (64 hex characters)";
      };
      salt = mkOption {
        type = types.str;
  ...
  config = mkIf cfg.enable {
    ...
    virtualisation.oci-containers.containers."langfuse-langfuse-web" = {
      ...
      environment = {
        ...
        "CLICKHOUSE_USER" = cfg.clickhouse.user;
        "DATABASE_URL" =
          "postgresql://${cfg.postgres.user}:${cfg.postgres.password}@postgres:5432/${cfg.postgres.database}";
        "EMAIL_FROM_ADDRESS" = "";
        "ENCRYPTION_KEY" = cfg.langfuse.encryptionKey;
        ...
        "LANGFUSE_S3_BATCH_EXPORT_SECRET_ACCESS_KEY" = cfg.minio.password;
        ...
        "LANGFUSE_S3_EVENT_UPLOAD_SECRET_ACCESS_KEY" = cfg.minio.password;
        ...
        "LANGFUSE_S3_MEDIA_UPLOAD_SECRET_ACCESS_KEY" = cfg.minio.password;
        "LANGFUSE_USE_AZURE_BLOB" = "false";
        "LANGFUSE_USE_OCI_NATIVE_OBJECT_STORAGE" = "false";
        "NEXTAUTH_SECRET" = cfg.langfuse.nextauthSecret;
        "NEXTAUTH_URL" = "http://localhost:3000";
        "REDIS_AUTH" = cfg.redis.password;
        "REDIS_HOST" = "redis";
        "REDIS_PORT" = "6379";
    ...
    virtualisation.oci-containers.containers."langfuse-minio" = {
      ...
      environment = {
        "MINIO_ROOT_PASSWORD" = cfg.minio.password;
    ...
    virtualisation.oci-containers.containers."langfuse-redis" = {
      ...
      volumes = [ "langfuse_langfuse_redis_data:/data:rw" ];
